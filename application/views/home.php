...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url()?>template/prototipe/assets/css/login.css" rel="stylesheet">
    <link href="<?php echo base_url()?>template/prototipe/assets/font-awesome/css/font-awesome.css" rel="stylesheet">
  ...
  <body>
      ...
      <div class="container">
    	<div class="row">
          <div class="col-xs-12 col-md-8" style="margin: 100px auto; color: #fff;">
            <div class="col-md-3">
              <p><img class="img-responsive" src="<?php echo base_url()?>template/prototipe/assets/img/logo.png" alt=""></p>
            </div>
    ...
    <script src="<?php echo base_url()?>template/prototipe/assets/bootstrap/js/bootstrap.min.js"></script>
  </body>
</html>
